...
# All rights reserved
# -------------------------------------------------------
# Mobile technology landscape part of about page
# -------------------------------------------------------
...
function SkillsLandscapeFiltersMobile() {
    ...
    /* --------- Compute sizes --------- */
    const heightString = `calc(100vh - ${height} - 40px)`;
    ...
    /* ----------- Define HTML --------- */
    return (
        <Paper style={{ position: 'sticky', backgroundColor: '#ffffff', marginTop: '20px', marginLeft: '20px', marginRight: '20px', top: height, zIndex: '1000', borderRadius: '0px', padding: '5px' }}>
...
export default SkillsLandscapeFiltersMobile;
